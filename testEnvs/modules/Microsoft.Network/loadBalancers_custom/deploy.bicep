...
var inboundNatPoolsVar = [for natPool in inboundNatPools: {
  name: natPool.name
  properties: {
...
resource loadBalancer 'Microsoft.Network/loadBalancers@2021-08-01' = {
  ...
  properties: {
    ...
    probes: probesVar
    inboundNatPools: inboundNatPoolsVar
  }
}

// Deployment Operations against Backend Pools are not supported on Basic LBs - mtb 1/22/23

  ...
  params: {
    ...
    extensionDSCConfig: {
      ...
      settings: {
        properties: {
          configuration: {
            url: 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-vmss-windows-dsc/Configuration.zip'
          }
          configurationArguments: {
            WebServerName: 'WebServer'
          }
          configurationData: {
            url: 'https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/201-vmss-windows-dsc/ConfigurationData.zip'
          }

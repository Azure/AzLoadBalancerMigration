...
param clusterName string = 'mtbsfcluster01'

@description('Remote desktop user Id')
param adminUsername string = 'admin-sf'
...
param sourceVaultResourceId string = '/subscriptions/24730882-456b-42df-a6f8-8590ca6e4e37/resourceGroups/rg-core/providers/Microsoft.KeyVault/vaults/mtbintkv01'

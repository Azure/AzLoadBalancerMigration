...
// basic lb
module loadbalancer2 '../modules/Microsoft.Network/loadBalancers_custom/deploy.bicep' = {
  name: 'lb-basic02'
  scope: resourceGroup(resourceGroupName)
  params: {
    name: 'lb-basic-02'
...
module availabilitySet2 '../modules/Microsoft.Compute/availabilitySets/deploy.bicep' = {
  scope: resourceGroup(resourceGroupName)
  name: 'as-02'
  params: {
    location: location
...
// module vm3 '../modules/Microsoft.Compute/virtualMachines_custom/deploy.bicep' = {
//   scope: resourceGroup(resourceGroupName)
//   name: 'vm-03'
//   params: {
//     name: 'vm-03'
...
//             loadBalancerBackendAddressPools: [
//               {
//                 id: loadbalancer2.outputs.backendpools[0].id
//               }
//             ]
//           }
//         ]
...
module vm4 '../modules/Microsoft.Compute/virtualMachines_custom/deploy.bicep' = {
  scope: resourceGroup(resourceGroupName)
  name: 'vm-04'
  params: {
    name: 'vm-04'
    adminUsername: 'admin-vm'
    adminPassword: '${uniqueString(randomGuid)}rpP@340'
    availabilitySetResourceId: availabilitySet2.outputs.resourceId
    location: location
    imageReference: {
      offer: 'WindowsServer'
      publisher: 'MicrosoftWindowsServer'
